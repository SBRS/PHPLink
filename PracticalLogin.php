   ...
   require("UserDetails.php");
    ...
    {			
		//The login is not successful, set the login flag to false
		    ...
		    $redirect_page = "http://dochyper.unitec.ac.nz/lia15/PHPPractical/index.php?content_page=".$_SESSION['request_page'];
			else
			$redirect_page = "http://dochyper.unitec.ac.nz/lia15/PHPPractical/index.php";
